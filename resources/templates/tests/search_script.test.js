...
describe('2. Тесты поиска по тексту (searchWord)', () => {
  ...
  /**
   * Тест 2.3: Отсутствие результатов
   ...
   */
  test('2.3 - Несуществующее слово должно показывать "Ничего не найдено"', () => {
  ...
  /**
   * Тест 2.4: Регистронезависимость поиска
   * Ожидание: Поиск "КНИГА" (заглавными) должен найти "книга" (строчными)
   */
  test('2.4 - Поиск должен работать независимо от регистра букв', () => {
    document.getElementById('searchText').value = 'КНИГА';
    searchWord();
